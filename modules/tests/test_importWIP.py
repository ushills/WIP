...
class TestImportWIP:
    ...
    def test_exportDataSql(self):
        ...
        data = {'projectName': 'test_project', 'projectNumber': 'test_project_number',
                        'wipDate': '1970-01-01', 'agreedVariationsNo': 1, 'budgetVariationsNo': 1,
                        'submittedVariationsNo': 1, 'variationsNoTotal': 3, 'orderValue': 6293357,
                        'agreedVariationsValue': 25450, 'budgetVariationsValue': 114,
                        'submittedVariationsValue': 56787, 'saleSubtotal': 6375708,
        ...
        assert all_rows == [('test_project_number', 1, '1970-01-01', 1, 1, 1, 3, 6293357, 25450, 114, 56787,
                             6375708, -254, -57, -5678, -9889, 6359828, 54874, 87899, 68998, 211771, 6148057,
                             5587, 147, 6153791, 6598787, 1144, 1, 'test_project')]
...
class TestMultiGraph:
    ...
    def test_importDataSql(self):
        ...
        assert importDataSql(searchData, request , db_name) == [('1970-01-01', 'test_project_number',
